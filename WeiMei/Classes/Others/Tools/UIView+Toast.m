...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position {
    [self makeToast:message duration:duration position:position backgroundColor:[UIColor blackColor] textColor:[UIColor whiteColor]];
}

/**
 * 弹出吐司 -> (白色背景和黑色字体)
 **/
- (void)makeToast2:(NSString *)message duration:(NSTimeInterval)duration position:(id)position
{
   [self makeToast:message duration:duration position:position backgroundColor:[UIColor whiteColor] textColor:[UIColor blackColor]];
}

- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position backgroundColor:(UIColor *)bgColor textColor:(UIColor *)txtColor
{
    UIView *toast = [self viewForMessage:message title:nil image:nil backgroundColor:bgColor textColor:txtColor];
    [self showToast:toast duration:duration position:position];
}

- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position title:(NSString *)title {
    UIView *toast = [self viewForMessage:message title:title image:nil backgroundColor:[UIColor blackColor] textColor:[UIColor whiteColor]];
    [self showToast:toast duration:duration position:position];  
}

- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position image:(UIImage *)image {
    UIView *toast = [self viewForMessage:message title:nil image:image backgroundColor:[UIColor blackColor] textColor:[UIColor whiteColor]];
    [self showToast:toast duration:duration position:position];  
}
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration  position:(id)position title:(NSString *)title image:(UIImage *)image {
    UIView *toast = [self viewForMessage:message title:title image:image backgroundColor:[UIColor blackColor] textColor:[UIColor whiteColor]];
    [self showToast:toast duration:duration position:position];  
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image backgroundColor:(UIColor *)bgColor textColor:(UIColor *)txtColor {
    // sanity
    ...
    if (CSToastDisplayShadow) {
        wrapperView.layer.shadowColor = bgColor.CGColor;
